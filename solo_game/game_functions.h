...
void read_player_attack_success(std::string, std::string, std::string, int);
void read_enemy_attack_success(std::string, std::string, std::string, int);
void read_player_attack_failure(std::string, std::string, std::string);
void read_enemy_attack_failure(std::string, std::string, std::string);
...
void read_combat_hit(std::string, std::string, int);
...
void read_combat_blinding_powder(std::string);
